...
namespace ManeProject.Infrastructure.Repository
{
    public static class BoxRepository
    {
        ...
        {
            private static IBoxArray[,] boxArrays;
            ...
            public Task<IBoxArray[,]> CreateBoxArray()
            {
                ...
                var rowColumnCount = (int)Math.Sqrt(dbArray.Count());

                boxArrays = InitTile(rowColumnCount,rowColumnCount,dbArray);

                return Task.FromResult(boxArrays);
            }
